...
def plot_results(emotion_labels, emotion_scores, truth_levels):
    """Plot the detected emotions and truth levels."""
...
def main():
    ...
    # Plot the results
    plot_results(emotion_labels, emotion_scores, truth_levels)
