...
- `streamlit run streamlit_app.py` - Gives you a streamlit UI with the facility o uploading a video for processing from your local and display the results in the same page.
